...
async def get_audio_status(task_id: str):
    """
    Fetches the processing status of an audio verification task from in-memory.
    """
    ...
    if task_result["status"] == "PENDING":
        ...
        return {"status": "Failed", "error": task_result["error"]}
...
async def get_audio_status(task_id: str):
    """
    Fetches the processing status of an audio verification task from using celery and redis.
    """
